...
/*
 * levelDB采用 little-endian 方式存储数据。先放低位，再放高位.
 * 提供Fixed32, Var32 编解码。
 */
...
// [p..limit-1]
extern const char
* GetVarint32Ptr(const char* p, const char* limit, uint32_t* v);
extern const char
* GetVarint64Ptr(const char* p, const char* limit, uint64_t* v);
